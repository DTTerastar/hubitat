 ...
 */
 ...
 metadata {
	definition (name: "Aeon Multisensor 6", namespace: "MichaelStruck", author: "Michael Struck") {
...
Note: May help if config parameters aren't making it before device goes back to sleep.
  ...
  <Value type="bool" index="enableDebugging" label="Enable debug logging?" value="true" setting_type="preference" fw="1.06,1.07,1.08,1.06EU,1.07EU">
    <Help>
    </Help>
  </Value>
</configuration>
